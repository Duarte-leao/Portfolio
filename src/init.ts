...
const publications: PublicationItem[] = [
  ...
  {
    title:
      "GraphRAG: Enhancing Reasoning Capabilities in Retrieval-Augmented Generation",
...
const projects: ProjectItem[] = [
  {
    name: "AI-Radiologist",
    description:
      "Developed prototype-based explainable AI models for medical image analysis through prototype-based learning approaches. Enhanced model interpretability.",
  ...
  },
  {
    ...
    description:
      "Develop novel and explainable models for medical image analysis through prototype-based learning approach model interpretability.",
...
function createSidebar() {
  ...
  title.textContent =
    "Bridging AI and Human Understanding through Interpretable Models";
...
function createContactSection() {
  ...
  content.className = "section-content";
  content.innerHTML =
    "<p>For research interests, research inquiries, or academic/professional opportunities.</p>";
  section.appendChild(content);
